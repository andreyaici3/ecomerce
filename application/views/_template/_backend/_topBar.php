...
<a href="assets/admin/index2.html" class="logo">
    ...
    <span class="logo-lg"><b>ANDREY</b>Store</span>
    </a>
    ...
    <div class="navbar-custom-menu">
        ...
        <li class="dropdown messages-menu">
            ...
            <li class="header">Kamu Punya 1 Pesan</li>
            <li>
        ...
        <li class="dropdown user user-menu">
            ...
            <span class="hidden-xs">  <?= $this->userdata->email ?></span>
            </a>
            <ul class="dropdown-menu">
            <!-- User image -->
            <li class="user-header">
                ...
                <p>
                <?= $this->userdata->name ?> - Web Developer
            ...
            <li class="user-body">
                ...
                <div class="col-xs-4 text-center">
                    <a href="#">100 Followers</a>
                </div>
                <div class="col-xs-4 text-center">
                    <a href="#">100 Sales</a>
                </div>
                <div class="col-xs-4 text-center">
                    <a href="#">100 Friends</a>
                </div>
                </div>
                <!-- /.row -->
            </li>
